...
public class google_maps extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(google_maps.this);
        fetchLocation();
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    edalamat_google_map.setText(getAddress(google_maps.this,currentLocation.getLatitude(),currentLocation.getLongitude()));
                    SupportMapFragment supportMapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.myMap);
                    assert supportMapFragment != null;
                    supportMapFragment.getMapAsync(google_maps.this);
                }
            }
        });
    }
