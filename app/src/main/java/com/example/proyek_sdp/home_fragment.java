...
public class home_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        kumpulanuser.add(new user("Edwin Sidharta",5,R.drawable.img1));
        kumpulanuser.add(new user("Julianto",4,R.drawable.img2));
        kumpulanuser.add(new user("Ferdinan",3,R.drawable.img3));
        kumpulanuser.add(new user("Richard Ivan",3,R.drawable.img3));
